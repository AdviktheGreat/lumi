  ...
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="p-3">
        <a
          href="/"
          className="flex items-center gap-2 rounded-lg border border-[var(--border)] px-3 py-2 text-xs font-medium text-[var(--text-secondary)] transition-all hover:bg-[var(--bg-hover)] hover:border-[var(--border-hover)] active:scale-[0.98]"
        >
          ...
          <a
            ...
            className={clsx(
              ...
              chat.id === activeChatId
                ? "bg-[var(--accent-light)] text-[var(--text)] active-indicator"
                : "text-[var(--text-secondary)] hover:bg-[var(--bg-hover)] hover:translate-x-0.5"
            )}
